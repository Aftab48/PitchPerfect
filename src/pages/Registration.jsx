        ...
        <>
              ...
              <div className="mb-4 text-white-800">
                ...
                <div className="flex items-center mb-2">
                  <input
                    ...
                    value="Yes"
                    checked={formData.personalInfo.previousInjuries === "Yes"}
                    onChange={handleChange}
                    className="mr-2"
                  />
                ...
                <div className="flex items-center">
                  <input
                    ...
                    name="previousInjuries"
                    value="No"
                    checked={formData.personalInfo.previousInjuries === "No"}
                    onChange={handleChange}
                    className="mr-2"
                  />
              ...
              <div className="mb-4 text-white-800">
                ...
                <div className="flex items-center mb-2">
                  <input
                    ...
                    value="ODIs"
                    checked={formData.cricketInfo.preferredFormat === "ODIs"}
                    onChange={handleChange}
                    className="mr-2"
                  />
                ...
                <div className="flex items-center mb-2">
                  <input
                    ...
                    name="preferredFormat"
                    value="T20s"
                    checked={formData.cricketInfo.preferredFormat === "T20s"}
                    onChange={handleChange}
                    className="mr-2"
                  />
                ...
                <div className="flex items-center">
                  <input
                    ...
                    value="Test Matches"
                    checked={
                      formData.cricketInfo.preferredFormat === "Test Matches"
                    }
                    onChange={handleChange}
                    className="mr-2"
                  />
          ...
          <div className="flex justify-between mt-4">
            {step > 1 && (
              <button
                onClick={prevStep}
                className="bg-green-300 text-black py-2 px-4 rounded-lg hover:bg-green-400 transition-all"
              >
                Previous
              </button>
            )}
