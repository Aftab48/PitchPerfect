...
const About = () => {
  return (
    <section className="bg-cover bg-center bg-[url('/assets/bg-3.png')] h-screen flex items-center">
      {/* <div className="bg-black bg-opacity-50 p-8"></div> */}
      <div className=" max-w-2xl p-8">
        <h1 className="text-8xl font-bold text-[#91F888] mb-6">
          ABOUT US
        </h1>
        ...
        <div className="text-center">
          <button className="bg-[#E31414] text-white font-bold text-2xl px-6 py-3 rounded-full hover:bg-red-600 transition">
            READ MORE
          </button>
        </div>
      </div>
